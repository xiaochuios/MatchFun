       ...
       // NSString *a=[NSString stringWithFormat: @"%d", w_x];
        ...
        for (int y = 0; y<TOTALY; y++) {
            for (int x = 0; x<TOTALX; x++) {
                ...
                [drawS spawnAtX:x Y:y Width:DRAWSPRITE_WIDTH Height:DRAWSPRITE_HEIGH addWidth2:150 AddHeigh2:200];
                ...
                [drawZ spawnAtX:x Y:y Width:DRAWSPRITE_WIDTH Height:DRAWSPRITE_HEIGH addWidth2:900 AddHeigh2:2000];
